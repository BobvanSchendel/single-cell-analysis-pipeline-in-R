...
# Run PCA on every dataset and find the significant dimensionality with an elbowplot
# and find (approximation of) significant dimensions in the datasets
...
SaveH5Seurat(jackson_e12.5_epicardial, paste(prenatal_directory, 'QC_jackson_e12.5_epicardial.h5Seurat', sep='/'), overwrite=TRUE)

SaveH5Seurat(forte_healthy_d0_epicardial, paste(postnatal_healthy_directory, 'QC_forte_healthy_d0_epicardial.h5Seurat', sep='/'), overwrite=TRUE)
SaveH5Seurat(forte_healthy_d7_epicardial, paste(postnatal_healthy_directory, 'QC_forte_healthy_d7_epicardial.h5Seurat', sep='/'), overwrite=TRUE)

SaveH5Seurat(wang_healthy_p8m1_epicardial, paste(postnatal_healthy_directory, 'QC_wang_healthy_p8m1_epicardial.h5Seurat', sep='/'), overwrite=TRUE)
SaveH5Seurat(wang_healthy_p8m3_epicardial, paste(postnatal_healthy_directory, 'QC_wang_healthy_p8m3_epicardial.h5Seurat', sep='/'), overwrite=TRUE)

SaveH5Seurat(vidal_young_epicardial, paste(postnatal_healthy_directory, 'QC_vidal_young_epicardial.h5Seurat', sep='/'), overwrite=TRUE)
SaveH5Seurat(vidal_old_epicardial, paste(postnatal_healthy_directory, 'QC_vidal_old_epicardial.h5Seurat', sep='/'), overwrite=TRUE)

SaveH5Seurat(forte_diseased_d1_epicardial, paste(postnatal_diseased_directory, 'QC_forte_diseased_d1_epicardial.h5Seurat', sep='/'), overwrite=TRUE)
SaveH5Seurat(forte_diseased_d3_epicardial, paste(postnatal_diseased_directory, 'QC_forte_diseased_d3_epicardial.h5Seurat', sep='/'), overwrite=TRUE)
SaveH5Seurat(forte_diseased_d5_epicardial, paste(postnatal_diseased_directory, 'QC_forte_diseased_d5_epicardial.h5Seurat', sep='/'), overwrite=TRUE)
SaveH5Seurat(forte_diseased_d7_epicardial, paste(postnatal_diseased_directory, 'QC_forte_diseased_d7_epicardial.h5Seurat', sep='/'), overwrite=TRUE)
SaveH5Seurat(forte_diseased_d14_epicardial, paste(postnatal_diseased_directory, 'QC_forte_diseased_d14_epicardial.h5Seurat', sep='/'), overwrite=TRUE)
SaveH5Seurat(forte_diseased_d28_epicardial, paste(postnatal_diseased_directory, 'QC_forte_diseased_d28_epicardial.h5Seurat', sep='/'), overwrite=TRUE)

SaveH5Seurat(wang_diseased_p8m1_epicardial, paste(postnatal_diseased_directory, 'QC_wang_diseased_p8m1_epicardial.h5Seurat', sep='/'), overwrite=TRUE)
SaveH5Seurat(wang_diseased_p8m3_epicardial, paste(postnatal_diseased_directory, 'QC_wang_diseased_p8m3_epicardial.h5Seurat', sep='/'), overwrite=TRUE)
